...
class LogathenaApplicationTests {
    ...
    void testGetThread() {
		...
		ParamsBusqueda params = new ParamsBusqueda(pathServicio:'/saldos/consultar',fechaLog:'2018_07_21c',limitResults:1)
		List<Map<String, Object>> documents = logQuery.searchTerm(params)
		def lines = logQuery.getThread(documents[0], "logbaz.\"2018_07_21c\"")
